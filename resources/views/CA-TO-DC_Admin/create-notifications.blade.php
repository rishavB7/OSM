...
@section('content')
    ...
    <div class="wrapper d-flex">
        ...
        <div class="container mt-0 mx-4 mb-4">
            <h4 class="text-center text-2xl mt-2">Create Notification</h4>
            ...
            <div class=" w-100 d-flex justify-content-center  align-items-center">
                ...
                <form method="POST" action="{{ route('createNotification') }}" class="w-[30%]"
                    ...
                    <div class="form-group w-[24rem]">
                        ...
                        <input id="file" class="form-control rounded-md" type="file" name="file"
                            value="{{ old('file') }}" required autocomplete="username" accept=".pdf" />
                        @error('file')
                            <p class="mt-2">{{ $message }}</p>
                        @enderror
                    </div>
