...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        for($dbcnt = 0; $dbcnt < count($dbname); $dbcnt++){
            Schema::connection($dbname[$dbcnt])->create('scheme_progress', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('scheme_id');
            $table->bigInteger('no_of_entries');
            $table->decimal('percentage_of_progress');
    ...
    {
        Schema::dropIfExists('scheme_progress');
    }
};
